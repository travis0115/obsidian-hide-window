...
class HideWindowSettingTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        settingDescEl.empty();
        settingDescEl.createEl('p', { 
            text: 'Enabled: the window will be hidden regardless of whether it is empty.',
            cls: 'setting-desc-line'
        }).style.marginBottom = '4px';
        settingDescEl.createEl('p', { 
            text: 'Disabled: the window will be hidden only when the last tab is empty.',
            cls: 'setting-desc-line'
